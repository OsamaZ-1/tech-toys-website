...
async function renderProduct() {
    ...
    document.getElementById("item-name").textContent = item.nameAR;
    document.getElementById("item-price").textContent = `$${item.price}`;
    document.getElementById("item-price-before").textContent = item.priceBefore !== "" ? `$${item.priceBefore}` : "";
    document.getElementById("item-age").textContent = item.ageAR;
    document.getElementById("item-category").textContent = item.categoryAR;
    document.getElementById("item-gender").textContent = item.genderAR;
    document.getElementById("item-desc").textContent = item.descriptionAR;
